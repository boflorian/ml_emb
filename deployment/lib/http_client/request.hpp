...
const char DEFAULT_HOST[] = "taltech-mles-app.ngrok.io"; // Change URL as needed
const char DEFAULT_URL_REQUEST[] = "/api/v1/test_large_request";
...
public:
    ...
    HttpRequest(const std::string& url, const std::string& host, uint16_t port);
    ~HttpRequest();
